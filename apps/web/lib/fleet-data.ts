...
export const FLEET_BY_CATEGORY: FleetVehicle[][] = [
  [
    ...
    { id: "3", img: "/fleet/economic/peugeot-e-208.webp", title: "Peugeot e-208", briefcase: 3, wifi: true, passengers: 4, category: "standard", isElectric: true },
  ...
  [
    ...
    { id: "14", img: "/fleet/executive/bentley-flying-spur.webp", title: "Bentley Flying Spur", briefcase: 4, wifi: true, passengers: 4, category: "executivo" },
    { id: "15", img: "/fleet/executive/mercedes-eqe-sedan.webp", title: "Mercedes EQE", briefcase: 2, wifi: true, passengers: 3, category: "executivo", isElectric: true },
    ...
    { id: "19", img: "/fleet/executive/tesla-model-s.webp", title: "Tesla Model S", briefcase: 3, wifi: true, passengers: 5, category: "executivo", isElectric: true },
  ],
  [
    ...
    { id: "22", img: "/fleet/van/toyota-hiace.webp", title: "Toyota HiAce", briefcase: 8, wifi: true, passengers: 8, category: "van" },
    { id: "23", img: "/fleet/executive/van-executiva.webp", title: "Mercedes EQV", briefcase: 8, wifi: true, passengers: 8, category: "van", isElectric: true },
