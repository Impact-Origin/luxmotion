...
export function ChildSeatCard({
  ...
  if (variant === "mobile") {
    return (
      <div
        className={cn(
          "min-w-0 w-full border rounded-xl p-2.5 flex flex-col shadow-[0px_4px_10px_rgba(0,0,0,0.05)]",
          className
        )}
        style={{
      ...
      >
        ...
        <div className="flex flex-col gap-0.5 min-h-[36px]">
          <h4
            className="text-[11px] font-bold leading-tight line-clamp-2 text-center"
            style={{ color: "var(--theme-checkout-form-label-text, #222222)" }}
          >
            {title}
          </h4>
          <p
            className="text-[9px] uppercase tracking-wide line-clamp-1 text-center"
  ...
  return (
    <div
      className={cn(
        "border-2 rounded-2xl overflow-hidden flex flex-col",
        className
      )}
      style={{
        backgroundColor: "var(--theme-checkout-form-card-bg, #FFFFFF)",
