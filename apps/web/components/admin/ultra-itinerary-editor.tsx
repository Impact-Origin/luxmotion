  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-base font-bold text-zinc-900">Day-by-day Itinerary</h3>
          <p className="text-xs text-zinc-500">Ultra-luxury tours only. Leave empty to fall back to the flat stops list.</p>
        </div>
        ...
        <div key={di} className="space-y-4 rounded-xl border border-amber-200 bg-amber-50/30 p-5">
          ...
          <div className="space-y-3">
            {day.stops.map((stop, si) => (
              <div key={si} className="space-y-3 rounded-lg border border-zinc-200 bg-white p-4">
                <div className="flex items-center justify-between">
