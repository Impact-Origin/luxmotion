...
const ROUTE_META: Record<string, { section: string; title: string }> = {
  ...
  experiences: { section: "Catalog", title: "Sobre nós" },
  "corporate-experiences": { section: "Catalog", title: "Experiências passadas" },
  ...
  inbox: { section: "Inbox", title: "Caixa de entrada" },
  applications: { section: "Inbox", title: "Candidaturas" },
