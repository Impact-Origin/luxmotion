...
export function IntroShell({
  ...
  return (
    <div className="w-full max-w-[800px] mx-auto flex flex-col items-center gap-6">
      ...
      <p className="text-center text-[16px] md:text-[18px] leading-[1.3] text-[#696969] max-w-[614px]">
        {subtitle}
      </p>
      {extra}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 w-full max-w-[614px]">
