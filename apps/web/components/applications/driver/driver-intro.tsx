...
function BookingPreview({ nowLabel, routeLabel, paidLabel }: { nowLabel: string; routeLabel: string; paidLabel: string }) {
  return (
    <div className="relative bg-white border border-[rgba(28,27,24,0.08)] flex flex-col items-center gap-2 px-6 py-3 animate-float-soft motion-reduce:animate-none shadow-[0_18px_40px_-20px_rgba(28,27,24,0.45)]">
      ...
      <span className="absolute -top-2 right-[-9px] flex items-center justify-center">
        <span className="absolute inset-0 rounded-full bg-[#a08248] animate-ping-strong motion-reduce:hidden" />
        <span className="relative bg-[#a08248] flex items-center justify-center rounded-full p-[7px]">
