...
export function DriverStepVerifyEmail() {
  ...
  return (
    ...
    >
      ...
      <EmailVerificationBanner email={email || t("placeholderEmail")} />

      <OtpInput
        value={code}
        onChange={(value) => {
          updateContact({ emailVerificationCode: value })
          setError(null)
        }}
        length={OTP_LENGTH}
        ariaLabel={t("title")}
      ...
      <button
        ...
        disabled={sending}
        className="text-[14px] font-semibold text-[#a08248] hover:text-[#8c6f3e] disabled:opacity-60 transition-colors mx-auto"
      >
