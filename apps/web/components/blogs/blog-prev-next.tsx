...
export function BlogPrevNext({ previous, next }: BlogPrevNextProps) {
  ...
  return (
    <section className="bg-[#141414] border-t-[0.8px] border-[rgba(255,255,255,0.07)] pt-[40.8px] pb-[40px] px-4 lg:px-[80px]">
      <div className="max-w-[1280px] mx-auto flex gap-[2px] items-stretch">
        {previous ? (
          <Link
            href={`/blogs/${previous.slug}`}
            className="group flex flex-1 min-w-px flex-col gap-2 border border-[rgba(255,255,255,0.12)] hover:border-[rgba(201,169,110,0.4)] p-[24.8px] transition-colors"
          >
            <div className="flex items-center gap-[7px]">
              <ArrowLeft className="size-3 text-[#999] group-hover:text-[#C9A96E] transition-colors" strokeWidth={2} />
              <span className="text-[12px] font-semibold uppercase tracking-[1.26px] text-[#999] group-hover:text-[#C9A96E] transition-colors">
                {t("previousArticle")}
              </span>
            </div>
            <p
        ...
        {next ? (
          ...
          >
            <div className="flex items-center justify-end gap-[7px]">
              <span className="text-[12px] font-semibold uppercase tracking-[1.26px] text-[#999] group-hover:text-[#C9A96E] text-right transition-colors">
                {t("nextArticle")}
              </span>
