...
export function EarningsComparison2() {
  const t = useTranslations("driversPage2.earnings")
  ...
  const rows: Row[] = [
    ...
    {
      label: t("row5Label"),
      uber: { kind: "text", value: t("row5CompValue") },
      bolt: { kind: "text", value: t("row5CompValue") },
    ...
    },
    {
      ...
      uber: { kind: "icon", type: "x" },
      bolt: { kind: "icon", type: "x" },
      luxmotion: { kind: "iconText", type: "check", value: t("row7LuxValue") },
    },
  ]
  ...
  return (
    <section className="relative bg-[#111110] py-14 lg:py-[56px] px-4 lg:px-[82px]">
      <div
        aria-hidden
        className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-[#9A7535] to-transparent"
      />
      <div
        aria-hidden
      ...
      <div className="max-w-[1280px] mx-auto flex flex-col gap-12 lg:gap-0 lg:flex-row lg:items-center lg:justify-between">
        <div className="flex flex-col gap-2.5 w-full lg:w-[379px] shrink-0">
          ...
          <div className="mt-4 bg-[rgba(201,169,110,0.04)] border-l-[1.92px] border-[rgba(201,169,110,0.3)] pt-[11.54px] pb-[11.86px] pl-[15.92px] pr-[14px]">
            <p
              className="text-[11px] font-bold leading-[17.6px] text-[#C9A96E]"
              style={SANS_FONT}
            >
              {t("exampleHeading")}
            </p>
            <p
              className="text-[11px] leading-[17.6px] text-[#999]"
              style={SANS_FONT}
            >
              {t("exampleBodyPre")}{" "}
              <span className="font-bold text-[#C4973E]">
                {t("exampleBodyHighlight")}
              </span>
              {t("exampleBodyPost")}
            </p>
          </div>
        ...
        <div className="flex flex-col items-end w-full lg:w-[850px] shrink-0">
          <div
            className={`flex h-[48px] lg:h-[57px] items-stretch ${rowDividerCls}`}
          >
