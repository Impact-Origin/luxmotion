...
function CardHeading({ children }: { children: React.ReactNode }) {
  return (
    <h3
      className="text-[28px] lg:text-[32px] leading-[1.2] text-[#1C1B18] mt-3"
      style={SERIF_FONT}
    >
      {children}
    </h3>
...
function CardBody({ children }: { children: React.ReactNode }) {
  return (
    <p
      className="text-[14px] leading-[1.2] text-[#696969] mt-4"
      style={SANS_FONT}
    >
      {children}
    </p>
...
function StatRow({
  ...
  return (
    <div className="border-t border-[rgba(28,27,24,0.08)] flex items-center gap-4 pt-3 mt-5">
      ...
      <p
        className="text-[12px] leading-[16.5px] text-[rgba(28,27,24,0.38)] max-w-[200px]"
        style={SANS_FONT}
      >
        {label}
      </p>
...
function AdvCard({
  ...
  return (
    ...
    >
      <div className="relative w-full lg:w-1/2 h-[280px] lg:h-auto lg:min-h-[460px] shrink-0">
        <Image
          src={card.photo}
          alt={card.photoAlt}
          fill
...
export function HowItWorks2() {
  const t = useTranslations("driversPage2.howItWorks")
  ...
  return (
    <section className="bg-[#F7F4EF] px-4 lg:px-[82px] py-16 lg:py-24">
      <div className="max-w-[1280px] mx-auto">
        ...
        <h2
          className="mt-3 text-[36px] lg:text-[48px] leading-[1.2] font-light text-[#1C1B18]"
          style={SERIF_FONT}
        >
          {t("titleLine1")}
          <br />
