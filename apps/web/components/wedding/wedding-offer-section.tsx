...
function SectionHeading({ eyebrow, titleStart, titleAccent }: { eyebrow: string; titleStart: string; titleAccent: string }) {
  return (
    <div className="flex flex-col gap-2 items-center w-full">
      ...
      >
        {titleStart}
        <span className="italic text-[#a08248] font-light">{titleAccent}</span>
      </h2>
    </div>
  )
}
