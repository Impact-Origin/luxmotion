...
function GuestCheckInCard() {
  ...
  return (
    <div className="absolute bottom-[-24px] right-[-10px] md:right-[-16px] w-[200px] xl:w-[232px] 2xl:w-[248px] bg-[#141414] border border-[rgba(201,169,110,0.22)] rounded-[4px] p-4 shadow-[0_20px_40px_-10px_rgba(0,0,0,0.6)]">
      <div className="flex items-center justify-between mb-3">
        <span
          className="text-[9px] tracking-[0.2em] uppercase text-[#C9A96E]"
          style={{ fontFamily: "var(--font-sans), system-ui, sans-serif" }}
        >
          {t("label")}
        </span>
      ...
      <div className="flex items-center gap-2.5 mb-3">
        <div
          className="w-8 h-8 rounded-full bg-[rgba(201,169,110,0.12)] border border-[rgba(201,169,110,0.3)] flex items-center justify-center text-[#C9A96E] text-[12px]"
          style={{ fontFamily: "var(--font-title), 'Cormorant Garamond', serif" }}
        >
          {t("guestInitial")}
        </div>
      ...
      <div className="flex flex-col gap-1.5 mb-3">
        <div className="flex items-center gap-2 text-[10px] text-[#C9C9C9]">
      ...
      <div className="flex gap-2 pt-3 border-t border-[rgba(255,255,255,0.08)]">
        <button
          type="button"
          className="flex-1 flex items-center justify-center gap-1.5 py-1.5 rounded-[2px] bg-[rgba(201,169,110,0.12)] border border-[rgba(201,169,110,0.3)] text-[10px] text-[#C9A96E] hover:bg-[rgba(201,169,110,0.2)] transition-colors"
          style={{ fontFamily: "var(--font-sans), system-ui, sans-serif" }}
        >
        ...
        <button
          type="button"
          className="flex-1 flex items-center justify-center gap-1.5 py-1.5 rounded-[2px] bg-[rgba(255,255,255,0.04)] border border-[rgba(255,255,255,0.08)] text-[10px] text-[#C9C9C9] hover:bg-[rgba(255,255,255,0.08)] transition-colors"
          style={{ fontFamily: "var(--font-sans), system-ui, sans-serif" }}
        >
