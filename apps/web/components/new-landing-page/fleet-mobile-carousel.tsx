    ...
    <div className="w-full">
      ...
      <div className="mt-6 flex items-center justify-center gap-4">
        <button
          ...
          className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-cyan-400/40 hover:bg-cyan-400/60 active:scale-95 transition-all"
        >
          ...
          {images.map((_, i) => (
            <button
              ...
              className={`h-2 rounded-full transition-all duration-200 ${
                i === current ? "w-6 bg-cyan-500" : "w-2 bg-cyan-200/70"
              }`}
            />
          ))}
        </div>
