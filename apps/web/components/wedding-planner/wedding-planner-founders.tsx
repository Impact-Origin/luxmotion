  ...
  return (
    <div className="relative h-10 w-[104px] shrink-0">
      {AVATARS.map((letter, i) => (
        <span
          key={letter}
          className="absolute top-0 size-10 rounded-full border border-[rgba(154,117,53,0.22)] bg-[rgba(170,153,110,0.2)] inline-flex items-center justify-center"
          style={{ left: `${3 + i * 30.5}px` }}
        >
          <span
            className="text-[14px] font-semibold text-[#ab9c6b] leading-[20px]"
            style={SANS_FONT}
          >
            {letter}
          </span>
